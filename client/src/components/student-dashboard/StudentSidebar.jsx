...
import { LayoutDashboard, BookOpen, Award, ClipboardList, Settings, LogOut, Sun, Moon, ArrowLeft } from 'lucide-react';
    ...
    return (
        <aside className="w-64 bg-white dark:bg-[#1a1c23] border-r border-gray-200 dark:border-gray-800 h-screen fixed left-0 top-0 overflow-y-auto z-20 hidden md:block">
            <div className="p-6 flex items-center gap-3">
                <NavLink to="/" className="p-2 -ml-2 mr-1 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-gray-600 dark:text-gray-300">
                    <ArrowLeft size={18} />
                </NavLink>
