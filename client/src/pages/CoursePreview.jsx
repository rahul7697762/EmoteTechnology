...
import {
    ArrowLeft, ChevronDown, ChevronRight, PlayCircle, FileText, Lock,
    CheckCircle, Menu
} from 'lucide-react';
                                        ...
                                        >
                                            ...
                                            <div className="text-left flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-2 mt-1.5">
                                                    ...
                                                    {lesson.isPreview && (
                                                        <span className="text-[10px] font-bold px-1.5 py-0.5 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded">
                                                            FREE
                                                        </span>
                                                    )}
                                                </div>
                ...
                <header className="h-16 bg-white dark:bg-[#1E293B] border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-6 shrink-0 z-10 shadow-sm">
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                        ...
                        <div className="border-l border-slate-200 dark:border-slate-600 pl-4 flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-400 font-medium tracking-wide uppercase">Preview Mode</p>
                        </div>
                    </div>
                    <button
                        onClick={() => navigate(`/edit-course/${id}`)}
                        className="ml-4 px-4 py-2 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-lg text-sm font-medium hover:opacity-90 transition-all shadow-sm hover:shadow active:scale-95 shrink-0"
                    >
                        Back to Edit
                    </button>
                </header>
                ...
                <main className="flex-1 flex flex-col overflow-hidden relative font-sans bg-[#F8FAFC] dark:bg-[#0F172A]">
                    {activeLesson ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-slate-500 bg-[#F8FAFC] dark:bg-[#0F172A]">
                            ...
                            <p className="text-slate-500 max-w-xs text-center">Select a lesson from the sidebar to begin previewing the course content.</p>
                        </div>
                    )}
                </main>
            </div>
