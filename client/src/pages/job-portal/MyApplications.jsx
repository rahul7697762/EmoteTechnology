...
const MyApplications = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      let filteredApps = response.applications || response;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-cyan-600 transition-all shadow-lg hover:shadow-xl"
          >
        ...
        {loading ? (
          ...
          >
            ...
            <a
              href="/jobs"
              className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-cyan-600 transition-all"
            >
              Browse Jobs
            </a>
          </motion.div>
