...
const JobDetailPage = ({ jobId: propJobId, onApply, onBack }) => {
  ...
  const { isFetchingJob } = useSelector((state) => state.job);
  ...
  const checkApplicationStatus = async () => {
    ...
    try {
      const response = await dispatch(getMyApplications()).unwrap();
      const apps = response.applications || response;
      const hasApplied = apps.some(app => app.job._id === jobId || app.job === jobId);
  ...
  if (isFetchingJob && !job) {
    return (
      <main className="pt-24 pb-16 px-6 lg:px-8 max-w-7xl mx-auto w-full">
  ...
  if (error || !job) {
    return (
      <main className="pt-24 pb-16 px-6 lg:px-8 max-w-7xl mx-auto w-full flex items-center justify-center min-h-[60vh]">
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                <div className="flex-1">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 rounded-xl bg-linear-to-br from-teal-400 to-cyan-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">
                      {job.company?.logo ? (
                        <img
                      ...
                      <>
                        {applied ? (
                          ...
                          <button
                            ...
                            className="px-8 py-3 bg-linear-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-cyan-600 transition-all shadow-lg"
                          >
                            Apply Now
                          </button>
                        )}
              ...
              {job.company && (
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-lg bg-linear-to-br from-teal-400 to-cyan-500 flex items-center justify-center text-white font-bold">
